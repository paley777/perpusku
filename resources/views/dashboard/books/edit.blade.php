...
@section('container')
    ...
    <h2 class="mt-3 mb-4">Edit Buku</h2>
    <span>Apabila data tidak tersedia, masukan strip ( - ) untuk setiap kolom.</span>

    <form method="post" action="/dashboard/books/{{ $book->id }}" class="row mt-3 g-3">
        @method('put')
        @csrf
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tgl" value="{{ old('tgl', $book->tgl) }}">
        </div>
        <div class="col-md-4">
            <label for="inputEmail3" class="form-label">Nomor Induk Judul</label>
            <input type="text" class="form-control" placeholder="Contoh : 0003" name="no_judul"
                value="{{ old('no_judul', $book->no_judul) }}" autofocus required>
        </div>
        <div class="col-md-4">
            <label for="inputEmail3" class="form-label">Nomor Induk Eksemplar</label>
            <input type="text" class="form-control" name="no_eks" placeholder="Contoh : 357"
                value="{{ old('no_eks', $book->no_eks) }}" required>
        </div>
        <div class="col-md-8">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="edisi" placeholder="Contoh : Cetakan Ke-1"
                value="{{ old('edisi', $book->edisi) }}" required>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-2">
            ...
            <input type="text" class="form-control" name="asal" placeholder="Contoh : BOS/APBD"
                value="{{ old('asal', $book->asal) }}" required>
        </div>
        <div class="col-md-6">
            <label for="inputEmail3" class="form-label">Keterangan</label>
            <input class="form-check-input" type="radio" name="keterangan"
                value="{{ old('keterangan', $book->keterangan) }}">
