...
@section('container')
    ...
    <h2 class="mt-3 mb-4">Tambah Transaksi</h2>
    <span>Apabila data tidak tersedia, masukan strip ( - ) untuk setiap kolom.</span>
    <form method="post" action="/dashboard/kembalis" class="row mt-3 g-3">
        @csrf
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="kelas" value="" placeholder="Masukkan Kelas Siswa." required>
        </div>
        <div class="col">
            <label for="inputEmail3" class="form-label">Buku yang Dikembalikan</label>
            <input type="text" class="form-control" name="kembali" value=""
                placeholder="Masukkan Buku yang Dipinjam Siswa. Setiap buku dipisahkan dengan koma (,)." autofocus required>
        </div>
        <button type="submit" class="btn btn-primary">Tambahkan Pengembalian</button>
    </form>
@endsection
